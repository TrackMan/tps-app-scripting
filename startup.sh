...
echo "VITE_DEV_BACKEND_BASE_URL='${VITE_DEV_BACKEND_BASE_URL:-NOT SET}'"
echo "VITE_DEV_LOGIN_BASE_URL='${VITE_DEV_LOGIN_BASE_URL:-NOT SET}'"
echo "VITE_DEV_OAUTH_WEB_CLIENT_ID='${VITE_DEV_OAUTH_WEB_CLIENT_ID:-NOT SET}'"
echo "VITE_DEV_OAUTH_WEB_CLIENT_SECRET='${VITE_DEV_OAUTH_WEB_CLIENT_SECRET:+SET}'"

echo "🔍 Production Environment Variables:"
echo "VITE_PROD_BACKEND_BASE_URL='${VITE_PROD_BACKEND_BASE_URL:-NOT SET}'"
echo "VITE_PROD_LOGIN_BASE_URL='${VITE_PROD_LOGIN_BASE_URL:-NOT SET}'"
echo "VITE_PROD_OAUTH_WEB_CLIENT_ID='${VITE_PROD_OAUTH_WEB_CLIENT_ID:-NOT SET}'"
echo "VITE_PROD_OAUTH_WEB_CLIENT_SECRET='${VITE_PROD_OAUTH_WEB_CLIENT_SECRET:+SET}'"
...
window.runtimeConfig = {
  ...
  VITE_DEV_BACKEND_BASE_URL: '${VITE_DEV_BACKEND_BASE_URL}',
  VITE_DEV_LOGIN_BASE_URL: '${VITE_DEV_LOGIN_BASE_URL}',
  VITE_DEV_OAUTH_WEB_CLIENT_ID: '${VITE_DEV_OAUTH_WEB_CLIENT_ID}',
  VITE_DEV_OAUTH_WEB_CLIENT_SECRET: '${VITE_DEV_OAUTH_WEB_CLIENT_SECRET}',
  
  // Production environment variables (for environment switcher)
  VITE_PROD_BACKEND_BASE_URL: '${VITE_PROD_BACKEND_BASE_URL}',
  VITE_PROD_LOGIN_BASE_URL: '${VITE_PROD_LOGIN_BASE_URL}',
  VITE_PROD_OAUTH_WEB_CLIENT_ID: '${VITE_PROD_OAUTH_WEB_CLIENT_ID}',
  VITE_PROD_OAUTH_WEB_CLIENT_SECRET: '${VITE_PROD_OAUTH_WEB_CLIENT_SECRET}',
